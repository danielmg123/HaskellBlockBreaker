...
/* package BrickBreaker-0.1.0.0 */
#ifndef VERSION_BrickBreaker
#define VERSION_BrickBreaker "0.1.0.0"
#endif /* VERSION_BrickBreaker */
#ifndef MIN_VERSION_BrickBreaker
#define MIN_VERSION_BrickBreaker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_BrickBreaker */
...
#define CURRENT_COMPONENT_ID "BrickBreaker-0.1.0.0-inplace-BrickBreaker"
